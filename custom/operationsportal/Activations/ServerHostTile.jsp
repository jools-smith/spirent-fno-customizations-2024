					...
					<tr>
						<td valign="top" align="left">
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td><span class="formLabel"><fmt:message key="portal.hosttile.label.serverHosts"/>&nbsp;&nbsp;</span></td>

									<td><a class="btn xsm" href="<%=addFunction%>" id="BAConfigHosts_AddServerHost">
							            							<fmt:message key="portal.hosttile.label.addServerhost"/>
							            						</a>
									</td>
								</tr>
							</table>
												...
												<td>
													<table cellpadding="0" cellspacing="0" width="100%">
														<tr>
															...
															<td width="30%"><span class="formLabel"><fmt:message key="portal.hosttile.label.serverHosts"/>:&nbsp;</span>
															</td>
															<td nowrap>
																<c:choose>
															...
															<td>
                                                                <tiles:insert page="/operationsportal/operations_split/toolTipTile.jsp">
                                                                    <tiles:put name="propertyName" value="nodeLockedHost"/>
                                                                    <tiles:put name="helpMessageKey" value="portal.CreateLicenseHost.help.nodeLockedHost"/>
                                                                </tiles:insert>
															</td>
														</tr>
		...
		<tr>
			<td>
				...
				<c:otherwise>
					...
					<c:if test="${'1'=='2'}">
					<tr>
						<td><span class="formLabel"><fmt:message key="portal.hosttile.label.nodelockedHosts"/></span></td>
						<td valign="top" align="left">
                            <a class="btn xsm" href="<%=addFunction%>" id="BAConfigHosts_AddServerHost"><fmt:message key="portal.configureLineItems.label.addNodelockedhost"/></a>
						</td>
					</tr>
					</c:if>
					<tr>
		...
		<tr>
			<td>
				...
				<c:otherwise>
					...
					<tr>
						<td valign="top" align="left">
							<label><fmt:message key="portal.configureLineItems.label.serverHosts"/></label>
                            <a class="btn xsm" href="<%=addFunction%>" id="BAConfigHosts_AddServerHost">
								<fmt:message key="portal.configureLineItems.label.addServerhost"/>
							</a>
						</td>
						<td></td>
					</tr>
												...
												<td>
													<table cellpadding="0" cellspacing="0" width="100%">
														<tr>
															...
															<td width="30%"><span class="formLabel"><fmt:message key="portal.configureLineItems.label.serverHosts"/>&nbsp;</span></td>
															<td nowrap>
																<html:select property="<%=serverSelectId%>" onchange="<%=onChangeFunction%>" styleClass="form">
																...
																<table border="0" cellspacing="5" cellpadding="0">
																	<tr>
																		...
																		<td align="right">
																			...
																			<a class="btn xsm" href="<%=addNLCountedHost%>">Add Host</a>
																		</td>
																	</tr>
																</table>
															</td>
														...
														<tr>
															<td>	
																<table border="0" id="ServerHost_1_hostIdTable" >
																	...
																	<tr>
																		<td>&nbsp;</td>
																		<td valign="top"><a  class="helplink">help text</a></td>	
																	</tr>
																</table>
															</td>
														</tr>
